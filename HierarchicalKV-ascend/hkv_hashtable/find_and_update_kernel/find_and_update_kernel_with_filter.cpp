...
/*!
 * \file find_and_update_kernel_with_filter.cpp
 * \brief find_and_update_kernel_with_filter
 */

#include "./v35/find_and_update_kernel_with_filter.h"
#include <cstdint>
...
extern "C" __global__ __aicore__ void find_and_update_kernel_with_filter(
  ...
  DISPATCH_VALUE_SIZE(
      ...
      DISPATCH_EVICT_STRATEGY(
          evict_strategy,
          (Simt::VF_CALL<find_and_update_kernel_with_filter_vf<
               uint64_t, DTYPE, uint64_t, STRATEGY>>(
